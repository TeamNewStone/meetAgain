...
<body class="index">
	...
	<nav class="navbar navbar-expand-lg navbar-dark bg-primary">
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="navbarNavDropdown-7">
				...
				<ul class="navbar-nav">
					<li class="nav-item dropdown" id="notice"><a class="nav-link"
						href="/meetAgain/views/board/notice.jsp"
						id="nav-inner-primary_dropdown_1" role="button"
						data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" onclick="goNotice();">공지사항</a>
					</li>
					<li class="nav-item dropdown" id="review"><a class="nav-link"
						href="#" id="nav-inner-primary_dropdown_1" role="button"
						data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">소모임</a>
					</li>
				</ul>


				<ul class="navbar-nav" id="login-nav">
					<li class="nav-item dropdown text-white" id="login"><a
						class="nav-link" href="#">로그인</a></li>
					<li class="nav-item dropdown" id="userIcon"><img src="/meetAgain/resources/img/usericon.png" alt="usericon"
						data-toggle="dropdown" class="img-fluid rounded-circle" style="width: 60px;">
						<div class="dropdown-menu dropdown-menu-right"
							aria-labelledby="nav-inner-primary_dropdown_1">
							<a class="dropdown-item" href="#" target="_blank">로그아웃</a> <a
								class="dropdown-item" href="profile.html" target="_blank">마이페이지</a>
							<a class="dropdown-item" href="#" target="_blank">개인정보수정</a>
						</div></li>
				</ul>
	...
	<script>
>>>>>>> 3128f92 2020-07-17_17:40 header, notice update
