					...
					<div class="row">
						<div class="custom-control custom-checkbox col-1.5 ">
							<input type="checkbox" class="custom-control-input" id="teens"
								...
								for="teens" style="font-weight: 400; margin-right: 10px;">10대</label>
						</div>
						<div class="custom-control custom-checkbox col-1.5">
	...
	<div class="row">
			...
			<div class="component">
				<div class="card">
					<div class="card-header">
						<iframe class="img-fluid" src="../../resources/img/mountainGangster1.jpg"
		...
		<div class="col-md-3">
			<div class="component">
				<div class="card">
					<div class="card-header">
						<iframe class="img-fluid" src="../../resources/img/mountainGangster2.jpg"
							style="width: 100%; display: block; margin: 0px auto;">
						</iframe>
					</div>
					<div class="card-body" style="height: 100%;">
		...
		<div class="col-md-3">
			<div class="component">
				<div class="card">
					<div class="card-header">
						<iframe class="img-fluid" src="../../resources/img/mountainGangster3.jpg"
							style="width: 100%; display: block; margin: 0px auto;">
						</iframe>
					</div>
					<div class="card-body" style="height: 100%;">
		...
		<div class="col-md-3">
			<div class="component">
				<div class="card">
					<div class="card-header">
						<iframe class="img-fluid" src="../../resources/img/mountainGangster4.jpg"
							style="width: 100%; display: block; margin: 0px auto;">
						</iframe>
					</div>
					<div class="card-body" style="height: 100%;">
